        ...
        <div class="row">
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-right">
                    <a href="{{ url('negocios/'.$id.'/servicios/nuevo-servicio') }}"
                        class="btn waves-effect waves-light btn-primary">Nuevo Servicio</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Ver Categoria -->
                                                <a href="{{ url('negocios/' . $id . '/servicios/'. $item->id .'/ver-servicio') }}"
                                                ...
                                                <div id="warning-header-modal-{{ $item->id }}" class="modal fade"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                action="{{ url('negocios/' . $id . '/servicios/'. $item->id .'/eliminar-servicio') }}">
                                                                @method('DELETE')
                                                                @csrf
