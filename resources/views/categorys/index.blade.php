        ...
        <div class="row">
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-right">
                    <a href="{{ url('categorias/nueva-categoria') }}"
                        class="btn waves-effect waves-light btn-primary">Nueva Categoria</a>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <!-- Ver Categoria -->
                                                <a href="{{ url('categorias/' . $item->id . '/ver-categoria') }}"
                                                    class="btn waves-effect waves-light btn-sm btn-dark"><i
                                                        class="fas fa-eye"></i></a>
                                                <!-- Editar Categoria -->
                                                <a href="{{ url('categorias/' . $item->id . '/editar-categoria') }}"
                                                ...
                                                <div id="warning-header-modal-{{ $item->id }}" class="modal fade"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                action="{{ url('categorias/' . $item->id . '/eliminar-categoria') }}">
                                                                @method('DELETE')
                                                                @csrf
