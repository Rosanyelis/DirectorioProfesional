            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="mt-3" method="POST"  action="{{ url('ciudades/'.$data->id.'/actualizar-ciudad') }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-control-label" for="inputDanger1">Nombre de Ciudad</label>
                                <input type="text" class="form-control  @error('name') is-invalid @enderror" name="name"
                                    placeholder="ejemplo: Guayaquil" value="{{ $data->name }}" id="inputDanger1">
                                @if ($errors->has('name'))
