        ...
        <div class="row">
            ...
            <div class="col-5 align-self-center">
                <div class="customize-input float-right">
                    <a href="{{ url('ciudades/nueva-ciudad') }}"
                        class="btn waves-effect waves-light btn-primary">Nueva Ciudad</a>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div id="warning-header-modal-{{ $item->id }}" class="modal fade"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form method="POST"
                                                                action="{{ url('ciudades/' . $item->id . '/eliminar-ciudad') }}">
                                                                @method('DELETE')
                                                                @csrf
